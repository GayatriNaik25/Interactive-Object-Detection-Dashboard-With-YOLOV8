...
with open(r"D:\cv2 project\yolo\coco.txt", "r") as my_file:
...
model = YOLO("D:\cv2 project\yolo\weight\yolov8n.pt", "v8")
...
cap = cv2.VideoCapture(r"C:\Users\new\VS\vscode.project\RESUME PROJCT\yolo\road.mp4")
